package com.example.timetodo.Utils;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TODO_TABLE = "CREATE TABLE " + TODO_TABLE + "(" + ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + TASK + " TEXT, " + STATUS + " INTEGER, " + DUE_TIME + " TEXT) ";
            ...
            if (cur != null) {
                if (cur.moveToFirst()) {
                    do {
                        ...
                        task.setDueTime(cur.getString(cur.getColumnIndex(DUE_TIME)));
                        taskList.add(task);
